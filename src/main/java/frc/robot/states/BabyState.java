...
public class BabyState implements State{
  ...
  public BabyState(String name, String parent){
    this.name = name;
    this.parent = parent;
...
/**DPAD 90 degree offset code*/
  ...
  public void periodic(RobotStateManager rs) {
    ...
    // default = 2/3 speed drive w/o slow button
    driveSubsystem.curvedArcadeDrive(xSpeed,zRotation,(1.0/3.0)-controllers.get(ControllerName.DRIVE, Axis.RT)/3.0);

    //Manual elevator control - disabled in baby mode
    // tvSubsystem.addElevator(-controllers.get(ControllerName.MANIP, Axis.RY)/50.0);

    // turret disabled in baby mode
    // handleTurretOffsets();
    ...
    //Manip Controller
      ...
      switch(event.button){
        ...
        case Y:
          ...
          break;
        //Elevator High - disabled
        //Elevator Load  - disabled
      }
    }
    return false;
  }
